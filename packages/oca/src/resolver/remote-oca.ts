...
// } from '@oca/constants'
// import { IOverlayBundleData } from '@oca/interfaces'
// import { BaseOverlay, BrandingOverlay, LegacyBrandingOverlay, OverlayBundle } from '@oca/types'
// import { generateColor } from '@oca/utils'
// import { CredentialIdentifiers, OverlayBundleResolver, OverlayBundleResolverOptions,  } from './oca'

// export interface RemoteOverlayBundleResolverOptions extends OverlayBundleResolverOptions {
...
// enum OverlayBundleQueueEntryOperation {
//   Add = 'add',
//   Remove = 'remove',
// }

// type OverlayBundleQueueEntry = {
//   sha256: string
//   operation: OverlayBundleQueueEntryOperation
// }
...
// export class RemoteOverlayBundleResolver extends OverlayBundleResolver {
...
//   constructor(indexFileBaseUrl: string, options?: RemoteOverlayBundleResolverOptions) {
//     super({}, options)
...
//    */
//   private processQueue = async (items: Array<OverlayBundleQueueEntry>): Promise<OverlayBundleQueueEntry[]> => {
//     const processed = Array<OverlayBundleQueueEntry>()
//     const operations = []
...
//       switch (q.operation) {
//         case OverlayBundleQueueEntryOperation.Add:
//           {
...
//           }
//           break
//         case OverlayBundleQueueEntryOperation.Remove:
...
//     newIndexFile: BundleIndex,
//     oldIndexFile: BundleIndex,
//   ): Array<OverlayBundleQueueEntry> => {
...
//       .map((hash) => ({
//         sha256: hash,
//         operation: OverlayBundleQueueEntryOperation.Remove,
//       }))
...
//       .map((hash) => ({
//         sha256: hash,
//         operation: OverlayBundleQueueEntryOperation.Add,
//       }))
...
//    */
//   private matchBundleIndexEntry = (identifiers: CredentialIdentifiers): string | undefined => {
